    ...
    <view v-if="!disabled" v-show="show" class="signature-contain">
      <view class="signature-main" style="z-index: 3000">
        <view class="signature-title"
          ><text v-for="(t, index) in titles" :key="index">{{ t }}</text></view
        >
        <canvas
          disable-scroll="true"
          class="signature"
        ...
        <view class="signature-btns">
          <view
            class="btn btn-cancel cu-btn bg-main margin-tb-sm text-white"
            @tap="cancelSignature()"
          >
            <text>取</text><text>消</text>
          </view>
          <view
            class="btn btn-clear cu-btn bg-main margin-tb-sm text-white"
            @tap="clearSignature()"
          >
            <text>清</text><text>空</text>
          </view>
          <view
            class="btn btn-ok cu-btn bg-main margin-tb-sm text-white"
            @tap="onOK()"
          >
